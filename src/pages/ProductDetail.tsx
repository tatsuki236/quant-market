...
const ProductDetail = () => {
  ...
  const isArticle = product.category === "有料記事";
                ...
                <div className="lg:col-span-2 space-y-8">
                  ...
                  <div>
                    ...
                    {product.rating_count > 0 && (
                      <div className="mt-3">
                        <StarRating mode="display" rating={product.rating_average} count={product.rating_count} size="md" />
                      </div>
                    )}
                  </div>

                  {/* 記事コンテンツ（無料パート + ペイウォール/有料パート） */}
                  ...
                  <div className="lg:sticky lg:top-24 p-6 rounded-xl bg-card border border-border card-glow">
                    ...
                    <div className="space-y-3 mb-6 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">電子書籍</span>
                      </div>
                    </div>
